//
//  EDBreakpointListContainerView.m
//  Editor
//
...
#import "EDBreakpointListContainerView.h"
#import "StatusBar.h"

#define NAVBAR_HEIGHT 0.0
#define OUTLINE_UGLY_FUDGE_Y 0.0

@implementation EDBreakpointListContainerView

+ (void)initialize {
    if ([EDBreakpointListContainerView class] == self) {
