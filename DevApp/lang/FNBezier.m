...
- (XPObject *)callWithWalker:(XPTreeWalker *)walker functionSpace:(XPMemorySpace *)space argc:(NSUInteger)argc {
    ...
    if (4 == argc) {
        ...
        if (x1Obj.isArrayObject && 4 == [x1Obj.value count] &&
            ...
            [[x1Obj.value objectAtIndex:2] isArrayObject] && 2 == [[(XPObject *)[x1Obj.value objectAtIndex:2] value] count] &&
            [[x1Obj.value objectAtIndex:3] isArrayObject] && 2 == [[(XPObject *)[x1Obj.value objectAtIndex:3] value] count])
        {
            y4Obj = [[(XPObject *)[x1Obj.value objectAtIndex:3] value] objectAtIndex:1];
            x4Obj = [[(XPObject *)[x1Obj.value objectAtIndex:3] value] objectAtIndex:0];
            y3Obj = [[(XPObject *)[x1Obj.value objectAtIndex:2] value] objectAtIndex:1];
            x3Obj = [[(XPObject *)[x1Obj.value objectAtIndex:2] value] objectAtIndex:0];
