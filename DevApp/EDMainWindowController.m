...
+ (NSArray *)triggers {
    ...
    if (!sTriggers) {
        sTriggers = [[NSArray alloc] initWithObjects:
                     ...
                     [OKTrigger triggerWithTemplate:@"assert(${condition}, ${comment})" specifier:@"assert"],
                     [OKTrigger triggerWithTemplate:@"copy(${object})" specifier:@"copy"],
                     //[OKTrigger triggerWithTemplate:@"copy(${object}, ${deep})" specifier:@"copy"],
                     [OKTrigger triggerWithTemplate:@"type(${object})" specifier:@"type"],
                     [OKTrigger triggerWithTemplate:@"Boolean()" specifier:@"Boolean"],
                     [OKTrigger triggerWithTemplate:@"Boolean(${object})" specifier:@"Boolean"],
                     [OKTrigger triggerWithTemplate:@"Number()" specifier:@"Number"],
                     [OKTrigger triggerWithTemplate:@"Number(${object})" specifier:@"Number"],
                     [OKTrigger triggerWithTemplate:@"String()" specifier:@"String"],
                     [OKTrigger triggerWithTemplate:@"String(${object})" specifier:@"String"],
                     [OKTrigger triggerWithTemplate:@"Array()" specifier:@"Array"],
                     [OKTrigger triggerWithTemplate:@"Array(${array})" specifier:@"Array"],
                     [OKTrigger triggerWithTemplate:@"Dictionary()" specifier:@"Dictionary"],
                     [OKTrigger triggerWithTemplate:@"Dictionary(${dictionary})" specifier:@"Dictionary"],
                     ...
                     [OKTrigger triggerWithTemplate:@"atan(${number})" specifier:@"atan"],
                     [OKTrigger triggerWithTemplate:@"atan2(${number})" specifier:@"atan2"],
                     [OKTrigger triggerWithTemplate:@"cos(${number})" specifier:@"cos"],
                     [OKTrigger triggerWithTemplate:@"sin(${number})" specifier:@"sin"],
                     [OKTrigger triggerWithTemplate:@"tan(${number})" specifier:@"tan"],
                     [OKTrigger triggerWithTemplate:@"degrees(${radians})" specifier:@"degrees"],
                     [OKTrigger triggerWithTemplate:@"radians(${degrees})" specifier:@"radians"],
                     [OKTrigger triggerWithTemplate:@"compare(${a}, ${b})" specifier:@"compare"],
                     [OKTrigger triggerWithTemplate:@"trim(${string})" specifier:@"trim"],
                     [OKTrigger triggerWithTemplate:@"lowerCase(${string})" specifier:@"lowerCase"],
                     [OKTrigger triggerWithTemplate:@"uppercase(${string})" specifier:@"uppercase"],
                     [OKTrigger triggerWithTemplate:@"matches(${string})" specifier:@"matches"],
                     [OKTrigger triggerWithTemplate:@"replace(${input}, ${pattern}, ${replacement})" specifier:@"replace"],
                     [OKTrigger triggerWithTemplate:@"replace(${input}, ${pattern}, ${replacement}, ${flags})" specifier:@"replace"],
                     [OKTrigger triggerWithTemplate:@"count(${sequence})" specifier:@"count"],
                     [OKTrigger triggerWithTemplate:@"position(${haystack}, ${needle})" specifier:@"position"],
                     [OKTrigger triggerWithTemplate:@"position(${haystack}, ${needle}, ${compareByIdentity})" specifier:@"position"],
                     [OKTrigger triggerWithTemplate:@"range(${stop})" specifier:@"range"],
                     [OKTrigger triggerWithTemplate:@"range(${start}, ${stop})" specifier:@"range"],
                     [OKTrigger triggerWithTemplate:@"range(${start}, ${stop}, ${step})" specifier:@"range"],
                     ...
                     [OKTrigger triggerWithTemplate:@"strokeWeight(${weight})" specifier:@"strokeWeight"],
                     [OKTrigger triggerWithTemplate:@"strokeCap(${type})" specifier:@"strokeCap"],
                     [OKTrigger triggerWithTemplate:@"strokeJoin(${type})" specifier:@"strokeJoin"],
