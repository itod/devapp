...
<head>
    ...
    <title>Grafik Konsol – A native graphics console for Mac OS</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <link rel="stylesheet" href="/grafikkonsol/master.css" type="text/css" media="screen"/>
    <link rel="icon" type="image/png" href="/grafikkonsol/i/icon_32x32.png"/>
...
<div id="head">
    ...
    <div class="inhalt">
        ...
        <div id="big-buttons" class="gc">
            ...
            <div id="buy-cell" class="gi">
            </div>
        </div>
        
        <div class="vers">Version 0.3. Just a svelte 6.3 MB download. Requires Mac OS 10.8 or later.</div>
        <div class="vers">
            <!-- <a href="/grafikkonsol/recover/">Lost your License?</a>
            &nbsp;•&nbsp; -->
            <a href="http://celestialteapot.com/bugs/">Report a Bug.</a>
        </div>
    </div> <!-- .inhalt -->
</div> <!-- #head -->
